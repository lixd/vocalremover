...
<template>
  <div class="home-view">
    <header class="page-header">
      <h1 class="title">去人声</h1>
      <h3 class="subtitle">从任何歌曲中去除人声，获取纯伴奏</h3>
    </header>
    ...
    <section class="description-section">
      <h2 class="section-title">从歌曲中去除人声</h2>
      <p class="section-text">
        通过先进的人工智能技术，您可以轻松地将歌曲中的人声去除，获取高质量的纯伴奏版本。
        只需上传音频文件，AI 算法会自动识别人声并将其分离，为您提供可用于卡拉OK、翻唱等场景的伴奏音轨。
      </p>
    </section>
  </div>
</template>
